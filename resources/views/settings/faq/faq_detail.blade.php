...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase">Detail FAQ</span>
            </div>
        </div>
        <div class="portlet-body form">
            <form class="form-horizontal form-bordered" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" name="question" class="form-control" value="{{$detail['question']??''}}" placeholder="Question"  required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="header" class="form-control" value="{{$detail['header_text']??''}}" placeholder="Header Text" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">
                            ...
                            <div class="col-md-9">
                                <select name="type" class="form-control" id="answer_type">
                                    ...
                                    <option value="step_by_step" {{ $detail['question_type'] == 'step_by_step' ? 'selected' : '' }}>Step by Step</option>
                                    <option value="webview" {{ $detail['question_type'] == 'webview' ? 'selected' : '' }}>Web View</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 answer-field">
                                @if ($detail['question_type'] == 'step_by_step')
                                    <input type="text" name="answer_header" class="form-control" value="{{$detail['answer_title']??''}}" placeholder="Answer Header Text" required/>
                                    <div class="form-action col-md-12" style="padding-bottom:15px; padding-top:15px;"><div class="row"><a class="btn btn-success btn_add_step" data-toggle="modal"><i class="fa fa-plus"></i> Add New Step</a></div></div>
                                    <div class="sortable">
                                        @if (count($detail['step_by_step_answer']) > 0)
                                            @foreach ($detail['step_by_step_answer'] as $step)
                                                <div class="portlet portlet-sortable light bordered col-md-12">
                                                    <div class="portlet-body">
                                                        <div class="col-md-1 text-center">
                                                            <i class="fa fa-arrows tooltips" data-original-title="Ubah urutan dengan drag n drop" data-container="body"></i>
                                                        </div>
                                                        <div class="col-md-4 text-center">
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="fileinput-new thumbnail" style="width: 150px;">
                                                                    <img class="previewImage" src="{{ env('STORAGE_URL_API')}}{{ $step['image'] }}" alt="">
                                                                </div>
                                                                <div class="fileinput-preview fileinput-exists thumbnail" id="image_landscape" style="width: 150px;"></div>
                                                                <div class="btnImage">
                                                                    <span class="btn default btn-file">
                                                                    ...
                                                                    <input type="file" id="0" accept="image/*" class="file form-control demo featureImageForm" name="file[]">
                                                                    </span>
                                                                    <a href="javascript:;" id="removeImage0" class="btn red fileinput-exists btremove" data-dismiss="fileinput"> Remove </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <div class="col-md-12" style="padding-bottom:15px;">
                                                                <input type="text" name="answer_title[]" class="form-control" placeholder="Title" value="{{ $step['title'] }}" required/>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <textarea name="answer_description[]" class="form-control" rows="2" placeholder="Description" required>{{ $step['description'] }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="portlet portlet-sortable light bordered col-md-12">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" name="answer_description[]" class="form-control" placeholder="Description" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                @elseif ($detail['question_type'] == 'webview')
                                    <input type="text" name="answer" class="form-control" placeholder="URL Webview" value="{{$detail['answer']??''}}" required/>
                                @else
                                    <textarea name="answer" class="form-control summernote" rows="10">{{$detail['answer']??''}}</textarea>
                                @endif
                            </div>
                        </div>
                    </div>
