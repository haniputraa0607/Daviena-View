        ...
        window.onload = function(event) {
            ...
            if (android.length != 0) {
                android.forEach(function(entry) {
                    $('#Android0').remove()
                    appendData('Android', 'Android', noAndroid, 'version_android', entry.app_version, entry.rules, entry.id);
                    noAndroid++;
                });
            } if (ios.length != 0) {
                ios.forEach(function(entry) {
                    $('#IOS0').remove()
                    appendData('IOS', 'IOS', noIOS, 'version_ios', entry.app_version, entry.rules, entry.id);
                    noIOS++;
                });
            }
        };

        function appendData(id, device, number, name, version, rules, id_version) {
            var allow = ''
            var not_allow = ''
            if (rules == 1) {
                var allow = 'selected'
                            ...
                            '<div class="col-md-12">'+
                                ...
                                '<div class="col-md-5">'+
                                    '<div class="input-group">'+
                                        '<input type="hidden" name="'+id+'[version]['+number+'][id]" value="'+id_version+'">'+
                                        '<input type="text" class="form-control" name="'+id+'[version]['+number+'][app_version]" value="'+version+'" required placeholder="'+device+' Version">'+
                                ...
                                '<div class="col-md-6">'+
                                    '<div class="input-group">'+
                                        '<select name="'+id+'[version]['+number+'][rules]" class="form-control" placeholder="Rules For Different Verion" required>'+
                    ...
                    '<div class="mt-repeater-item mt-overflow">'+
                        '<div class="mt-repeater-cell">'+
                            '<div class="col-md-12">'+
                                ...
                                '<div class="col-md-5">'+
                                    '<div class="input-group">'+
                                        '<input type="text" class="form-control" name="'+id+'[version]['+number+'][app_version]" value="@if(isset($version['+name+'])){{ $version['+name+'] }}@endif" required placeholder="'+device+' Version">'+
                                        '<span class="input-group-addon">'+
                                            '<i style="color:#333" class="fa fa-question-circle tooltips" data-original-title="Versi aplikasi '+device+' terbaru" data-container="body"></i>'+
                                        '</span>'+
                                    '</div>'+
            ...
            <div class="form-body">
                <div class="portlet-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="">
                            <a href="#tab_display_androidios" data-toggle="tab" aria-expanded="false"> Display Setting </a>
                        </li>
                    </ul>
                                            ...
                                            <div class="mt-repeater-item mt-overflow">
                                                <div class="mt-repeater-cell">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="Android[version][0][app_version]" required placeholder="Android Version">
                                                                <span class="input-group-addon">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <select name="Android[version][0][rules]" class="form-control" placeholder="Rules For Different Verion" required>
                                                                    <option disabled selected value="">Rules For Different Version</option>
                                                                    <option value="1">Allowed</option>
                                                                    <option value="0">Not Allowed</option>
                                                                </select>
                        ...
                        <div class="tab-pane fade" id="tab_IOS">
                            <form class="form-horizontal" role="form" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mt-repeater-item mt-overflow">
                                                <div class="mt-repeater-cell">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="IOS[version][0][app_version]" required placeholder="IOS Version">
                                                                <span class="input-group-addon">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                <select name="IOS[version][0][rules]" class="form-control" placeholder="Rules For Different Verion" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="IOS[version_appstore]" value="@if(isset($version['version_appstore'])){{ $version['version_appstore'] }}@endif" placeholder="Appstore Link">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-icon right">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        @else
                                                        <img src="https://via.placeholder.com/500x500?text=No+Image" alt="">
                                                        @endif
                                                        </div>
