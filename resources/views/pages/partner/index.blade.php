...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body">
            <a href="{{ route('partner.create') }}" class="btn btn-success btn_add_user" style="margin-bottom: 15px;">
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="table_data">
                <thead>
                    <tr style="text-align: center">
                        <th style="text-align: center"> Partner Code </th>
                    ...
                    @if (!empty($partners))
                        @foreach ($partners as $partner)
                            <tr style="text-align: center;">
                                ...
                                <td style="width: 90px;">                    
                                    <a data-id="{{ $partner['id'] }}" data-name="{{ $partner['partner_name'] }}" class="btn btn-sm blue" onclick="main.detail(this)"><i class="fa fa-search"></i></a>
                                    <a class="btn btn-sm red sweetalert-delete btn-primary" data-id="{{ $partner['id'] }}" data-name="{{ $partner['partner_name'] }}" onclick="main.delete(this)"><i class="fa fa-trash-o"></i></a>           
                                </td>
                            </tr>
                        @endforeach
                    @endif
