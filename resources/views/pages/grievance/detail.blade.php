...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue bold uppercase">Detail Grievance</span>
            </div>
        </div>

        <div class="portlet-body m-form__group row">
            <form class="form-horizontal" role="form" action="{{ url('grievance/update') . '/' . $detail['id'] }}"
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <label class="control-label">Name<span class="required" aria-required="true">*</span>
                                        <i class="fa fa-question-circle tooltips" data-original-title="Nama Grievance"
                                ...
                                <div class="col-md-9">
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="name"
                                            value="{{ $detail['grievance_name'] }}" placeholder="Name (Required)" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-3">
                                    <label class="control-label">Description<span class="required"
                                        ...
                                        <i class="fa fa-question-circle tooltips"
                                            data-original-title="Description Grievance" data-container="body"></i>
                                    </label>
                                </div>
                                <div class="col-md-9">
                                    <div class="col-md-10">
