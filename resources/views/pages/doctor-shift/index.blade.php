...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase">CMS Doctor Shift List</span>
            </div>
        </div>
        <div class="portlet-body">
            <a href="{{ route('doctor-shift.create') }}" class="btn btn-success btn_add_user" style="margin-bottom: 15px;">
            ...
            <table class="table trace trace-as-text table-striped table-bordered table-hover dt-responsive" id="table_data">
                <thead class="trace-head">
                    <tr>
                        ...
                        <th style="text-align: center"> Shift's Name </th>
