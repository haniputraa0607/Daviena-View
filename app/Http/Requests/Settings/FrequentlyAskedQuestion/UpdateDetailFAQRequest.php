...
class UpdateDetailFAQRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'id_step' => Rule::when($this->type == 'step_by_step', 'required|array|min:1', 'prohibited'),
            'id_step.*' => Rule::when($this->type == 'step_by_step', 'nullable|string', 'prohibited'),
            ...
            'file' => Rule::when($this->type == 'step_by_step', 'nullable|array|min:1', 'prohibited'),
            'file.*' => Rule::when($this->type == 'step_by_step', 'nullable|mimes:png,jpg|max:5120', 'prohibited'),
        ];
    }
